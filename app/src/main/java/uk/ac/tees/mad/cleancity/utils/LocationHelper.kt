...
// check permission->getcurrentLocation()
// reverse geocoding-?get address for location
//return location data class
...
class LocationHelper(private val context: Context) {
    ...
    suspend fun getCurrentLocation(): Location? {
        ...
        // to get location asynchronously wihotut blocking the ui
...
data class  LocationData(
    ...
    val postalCode: String? = null     // Postal code:
)